  ...
  const pricingOptions = [
    {
      ...
      title: 'Basic',
      price: '$56.99',
      features: ['Frontend-Site', 'React'],
    },
    {
      id: 2,
      title: 'Pro',
      price: '$99.99',
      features: ['Frontend-Site', 'React+Next', 'Authentication'],
    },
    {
      id: 3,
      title: 'Premium',
      price: '$29.99',
      features: ['MERN', 'Routrs', 'Exclusive-site', 'Authentication', 'Database-Setup'],
    },
  ];
  ...
  return (
    <section className="bg-transparent px-10 py-16" id="pricing">
      ...
      >
        {selectedPlan && (
          <motion.div
            className="modal-content backdrop-blur-sm bg-white/30 border-red-600 w-1/3 h-1/2 rounded-lg p-6 max-w-xl flex flex-col justify-between"
